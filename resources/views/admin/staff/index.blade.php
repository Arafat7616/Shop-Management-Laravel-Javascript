...
@section('rightbar-content')
                                ...
                                <tbody>
                                    @foreach ($staffs as $staff)
                                        <tr @if ($staff->status == 0) style="background-color: #631717" @endif>
                                            ...
                                            <td>{{ $staff->invoice->sum('total_price') - $staff->invoice->sum('paid_amount') }}
                                            </td>
    ...
    <!-- End Contentbar -->
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="add-staff-modal" data-backdrop="static" tabindex="-1" role="dialog"
                        ...
                        <form id="form_id" action="{{ route('admin.staff.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon3" style="background-color: #752323">Staff
                                        Name</span>
                                </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control" name="email" id="email"
                                    value="{{ old('email') }}" aria-describedby="basic-addon3">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon3"
                                        style="background-color: #752323">Password</span>
                                </div>
                                <input type="password" class="form-control" name="password" id="password"
                                    value="{{ old('password') }}" aria-describedby="basic-addon3">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <button type="submit" id="submit-btn" class="btn btn-success btn-lg btn-block">Add
                                Staff</button>
                            <button type="button" id="update-btn" class="btn btn-warning btn-lg btn-block">Update
                                Now</button>
                        </form>
                    </div>
                    <!--data listing table-->
