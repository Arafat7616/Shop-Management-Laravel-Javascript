...
$(document).ready(function() {
    ...
    var scatterPlotChart = c3.generate({
        ...
        color: { pattern: ["#dcdde1", "#fcc100", "#6e81dc"] },
        data: {
            xs: {
                setosa: 'setosa_x',
    ...
    var stackedBarChart = c3.generate({
        ...
        color: { pattern: ["rgba(255,255,255,0.05)", "#6e81dc", "#fcc100"] },
        data: {
            columns: [
    ...
    var combinationChart = c3.generate({
        ...
        color: { pattern: ["#6e81dc", "rgba(255,255,255,0.05)", "#f44455", "#5fc27e", "#fcc100", "#72d0fb"] },
        data: {
            columns: [
    ...
    var gaugeChart = c3.generate({
        ...
        color: {
            pattern: ['#fcc100', '#5fc27e', '#f44455', '#6e81dc'],
            threshold: {
                values: [30, 60, 90, 100]
            }
        },
    ...
    var pieChart = c3.generate({
        bindto: '#c3-pie',
        color: { pattern: ["#6e81dc", "rgba(255,255,255,0.05)", "#fcc100"] },
        data: {
            columns: [
                ['SeriesA', 40],
                ['SeriesB', 25],
