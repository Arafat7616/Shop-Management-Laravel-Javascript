    ...
    var lineDiffPoint = new Chart(lineDiffPointID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBorderColor: ["transparent","transparent","transparent","transparent","transparent","transparent","transparent"],
                pointBackgroundColor: ["rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)"],
                fill: false,
        ...
        var lineChart = new Chart(linechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBackgroundColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
                    pointBorderWidth: 2,
        ...
        var scatterChart = new Chart(scatterChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    pointBackgroundColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
                    pointBorderWidth: 2,
                    label: 'Series A',
                    data: [{
                        x: 1,
        ...
        var multiAxisBarChart = new Chart(multiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#6e81dc","#fcc100","rgba(255,255,255,0.05)","#5fc27e","#f44455","#72d0fb","#2d3646"],
                        yAxisID: 'y-axis-1',
            ...
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        ...
                        label: 'Series C',
                        backgroundColor: ["rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)", "rgba(255,255,255,0.05)"],
        ...
        var lineBarMixed = new Chart(lineBarMixedID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["rgba(255,255,255,0.05)"],
                    borderColor: ["rgba(255,255,255,0.05)"],
                    pointBorderColor: ["rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)"],
                    pointBorderWidth: 2,
                    pointBackgroundColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
        ...
        var datasetArea = new Chart(datasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBackgroundColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
                    pointBorderWidth: 2,
                    ...
                    borderColor: ["rgba(255,255,255,0.05)"],
                    pointBorderColor: ["rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)","rgba(255,255,255,0.05)"],
                    pointBackgroundColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
                    pointBorderWidth: 2,
        ...
        var radarArea = new Chart(radarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    backgroundColor: ["rgba(244, 68, 85,0.5)"],
                    borderColor: ["#f44455"],
                    pointBorderColor: ["#212229","#212229","#212229","#212229","#212229","#212229","#212229","#212229"],
        ...
        var polarAreaChart = new Chart(polarAreaChartID, {
            ...
            data: {
                datasets: [{
                    data: [65,91,56,84,47],
                    borderColor: 'transparent',
                    backgroundColor: ["rgba(244, 68, 85,0.5)","rgba(110, 129, 220,0.5)","rgba(252, 193, 0,0.5)","rgba(255,255,255,0.05)","rgba(95, 194, 126,0.5)"],
                    label: 'Dataset 1'
                }],
